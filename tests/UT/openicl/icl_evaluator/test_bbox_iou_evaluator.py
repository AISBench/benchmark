...
class TestBBoxIoUEvaluator(unittest.TestCase):
    def test_should_score_accuracy_when_prediction_matches_reference_given_normalized_bbox(self):
        # given
    ...
    def test_should_clip_prediction_to_image_bounds_when_scaling_bbox_given_out_of_range_coordinates(self):
        # given
    ...
    def test_should_report_invalid_detail_when_prediction_cannot_form_valid_bbox_given_reversed_coordinates(self):
        # given
    ...
    def test_should_return_error_when_prediction_and_reference_lengths_differ_given_mismatched_inputs(self):
        # given
        evaluator = BBoxIoUEvaluator()
    ...
    def test_should_use_custom_metric_prefix_and_reference_keys_when_scoring_given_custom_schema(self):
        # given
        evaluator = BBoxIoUEvaluator(
    ...
    def test_should_register_evaluator_when_bbox_iou_module_is_imported_given_registry_lookup(self):
        # given / when
