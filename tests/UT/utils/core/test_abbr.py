...
from ais_bench.benchmark.utils.core.abbr import (
    ...
    merged_dataset_abbr_from_class,
    task_abbr_from_cfg,
...
class TestAbbrUtilities(unittest.TestCase):
    ...
    def test_merged_dataset_abbr_from_class(self):
        """Test merged_dataset_abbr_from_class extracts type"""
        cfg = ConfigDict({"type": "ais_bench.benchmark.datasets.GSM8KDataset"})
        
        result = merged_dataset_abbr_from_class(cfg)
        
        self.assertEqual(result, "gsm8kdataset")
