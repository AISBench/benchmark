...
class TestTypeValidationUtilities(unittest.TestCase):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_type_list_valid_match(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_type_list_none_match(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_type_list_invalid_type(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_dataset_valid_dataset(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_dataset_valid_dataset_dict(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_dataset_invalid_type(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_list_valid(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_list_invalid_type(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_str_valid(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_str_invalid_type(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_dict_valid(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_dict_invalid_type(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_type_valid(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_type_none_valid(self, mock_logger):
        """Test check_type with None when NoneType expected"""
        result = check_type(None, type(None))
        self.assertIsNone(result)

    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_type_none_invalid(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_type_mismatch(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_type_long_repr_truncated(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_meta_json_dict_valid_minimal(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_meta_json_dict_valid_with_request_count(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_meta_json_dict_invalid_request_count(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_meta_json_dict_illegal_keys(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_meta_json_dict_type_mismatch(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_meta_json_dict_nested_output_config(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_output_config_no_config(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_output_config_missing_params(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_output_config_uniform_valid(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_output_config_uniform_invalid_values(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_output_config_uniform_min_greater_than_max(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_output_config_uniform_missing_params(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_output_config_percentage_valid(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_output_config_percentage_missing_param(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_output_config_percentage_invalid_format(self, mock_logger):
    ...
    @patch("ais_bench.benchmark.utils.core.types.logger")
    def test_check_output_config_unsupported_method(self, mock_logger):
