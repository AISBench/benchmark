...
- **Dependency conflicts**: harbor==0.6.1 forces datasets to be upgraded to 4.0+, which would pollute the main environment; the runtime image uses an isolated venv
