...
- **\[2026.3.1\]** Support for integrating judge models for evaluation. See [Evaluate with Judge Models](https://ais-bench-benchmark-rf.readthedocs.io/en/latest/advanced_tutorials/judge_model_evaluate.html). 🔥🔥🔥
